...
<figure>
  <img src="{{ 'assets/img/about-02.jpg' | relative_url }}" alt="the SEMYOME (Semiahmoo) Territory of my childhood" float="right">
...
As part of my PhD dissertation project, artist [TEMOSEṈ](https://wsanec.com/avada_portfolio/temoseng-chazz-elliott/) and I prototyped the first iteration of a “haptic map” concept, [the _Untitled ṮEṮÁĆES_ map](https://www.namescape.ca/2022/08/intro-to-haptic-map.html): a motion-activated art installation that plays audio clips of spoken toponyms in [SENĆOŦEN](https://www.firstvoices.com/explore/FV/sections/Data/THE%20SEN%C4%86O%C5%A6EN%20LANGUAGE/SEN%C4%86O%C5%A6EN/SEN%C4%86O%C5%A6EN) and English. 

This installation portrays an artistic representation of a W̱SÁNEĆ territory seascape but without signs, cardinal directions, borders, or the usual elements found on Western-style maps. You walk into a wraparound map space of what looks like a seascape with a distance horizon.
